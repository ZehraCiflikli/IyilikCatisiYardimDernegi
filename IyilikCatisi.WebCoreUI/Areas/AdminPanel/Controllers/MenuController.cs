...
using IyilikCatisi.Business.Concrete.BaseConcrete;
using IyilikCatisi.Model.Entity;
using IyilikCatisi.Model.ViewModel.Areas.AdminPanel;

namespace IyilikCatisi.MVCCoreUI.Areas.AdminPanel.Controllers
{
    [Area("AdminPanel")]
    public class MenuController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            model.UstMenuListe.Insert(0, new SelectListItem() { Text = "Lütfen Üst Kategori Seçiniz", Value = "0" });
        ...
        public IActionResult Update(IFormCollection data)
        {
           ...
           m.Url = data["url"];
            ...
            return Json(new { result = true, mesaj = "Menü Başarıyla Güncellendi", model = model });
        }
